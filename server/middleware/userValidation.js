...
export const userValidator = [
   body('firstName').isString().isLength({ min: 3, max: 25 }).withMessage('Please enter min 3 and max 25 symbols').notEmpty().trim(),
   body('lastName').isString().isLength({ min: 3, max: 25 }).withMessage('Please enter min 3 and max 25 symbols').notEmpty().trim(),
